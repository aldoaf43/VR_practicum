...
public class mover_tapa_6 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Vector3 pos_valvula= new Vector3(seguir_valvula.objeto.x-0.575f,seguir_valvula.objeto.y-0.4173f,seguir_valvula.objeto.z-0.49f);
        if(mover_tapa==1 && rotate.contar%2==0){
            rb.constraints=RigidbodyConstraints.FreezeRotation;
            rb.constraints=RigidbodyConstraints.FreezePositionX;
            rb.constraints=RigidbodyConstraints.FreezePositionZ;
        }else if (mover_tapa==1 && rotate.contar<8){

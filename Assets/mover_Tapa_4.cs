...
public class mover_Tapa_4 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //Vector3 pos_valvula= new Vector3(seguir_valvula.objeto.x-0.575f,seguir_valvula.objeto.y-0.4073f,seguir_valvula.objeto.z-0.49f);
        Vector3 pos_valvula= new Vector3(seguir_valvula.objeto.x+inicial.x-0.225f,seguir_valvula.objeto.y+dif.y,seguir_valvula.objeto.z-dif.z+0.01f);
        if(mover_tapa==1 && rotate.contar%2==0){
            rb.constraints=RigidbodyConstraints.FreezeRotation;
            rb.constraints=RigidbodyConstraints.FreezePositionX;
            rb.constraints=RigidbodyConstraints.FreezePositionZ;
        }else if (mover_tapa==1 && rotate.contar<6){
